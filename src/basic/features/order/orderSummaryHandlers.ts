/**
 * ========================================
 * 주문 요약 정보 관련 이벤트 핸들러 (순수 함수)
 * ========================================
 *
 * 주문 요약 정보와 관련된 이벤트 핸들러들을 순수 함수로 분리합니다.
 * 장바구니 계산, 할인 적용, 포인트 계산 등을 관리합니다.
 */

import { useCartState } from '../cart/store/cartState.ts';
...
import { calculateCart } from '../cart/cartCalculationUtils.ts';
import {
  CartItemSummary,
  SubtotalSummary,
  BulkDiscountSummary,
  ...
  ShippingSummary,
} from './SummaryDetails.ts';
import { DiscountInfo } from './DiscountInfo.ts';
 ...
 */
export const handleCalculateCartStuff = (): void => {
  // 장바구니 상태 가져오기
